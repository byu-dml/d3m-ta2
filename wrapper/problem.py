...
class Problem:
    ...
    def get_from_protobuf(protobuf_problem: grpc_problem.Problem):
        ...
        performance_metrics = [ProblemPerformanceMetric.get_from_protobuf(problem_performance_metric) for problem_performance_metric in protobuf_problem.performance_metrics]
