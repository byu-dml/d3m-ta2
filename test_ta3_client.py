...
class GrpcServerTestCase(unittest.TestCase):
    ...
    def test_search_solutions_response_search_id(self):
        ...
        if len(search_id_1) < 22:
            self.fail(
                f'search_id \'{search_id_1}\' returned in SearchSolutionsResponse is either empty or less than 22 characters')
        ...
        self.assertNotEqual(search_id_1, search_id_2,
                            f'Two consecutive calls to SearchSolutions produced the same search_id: {search_id_1}')
