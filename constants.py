PROTOCOL_ERROR_MESSAGE = 'TA3 protocol version does not match TA2 protocol version'
SEARCH_ID_ERROR_MESSAGE = 'search_id argument provided in GetSearchSolutionsResultsRequest does not match any search_process'
DESCRIBE_SOLUTION_ERROR_MESSAGE = 'solution_id argument provided in DescribeSolutionRequest does not match any solution_id'
