...
class TestHelloResponse:
    ...
    def test_is_hello_response(stub: core_pb2_grpc.CoreStub):
        ...
        assert isinstance(response, core_pb2.HelloResponse), 'call to Hello did not return an instance of SearchSolutionsResponse'
    ...
    def test_response_contains_required_fields(stub: core_pb2_grpc.CoreStub):
        ...
        assert allowed_value_types is not None and len(allowed_value_types) > 0, 'HelloResponse did not contain allowed_value_types'
